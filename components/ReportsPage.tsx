                        ...
                        <div className="overflow-x-auto"><table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {paginatedFarmers.map(f => (<tr key={f.id}>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-mono">{f.hap_id}</td><td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{f.fullName}</td><td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{getGeoName('village', f)}, {getGeoName('mandal', f)}</td><td className="px-6 py-4 whitespace-nowrap text-sm">{f.status}</td><td className="px-6 py-4 whitespace-nowrap text-sm">{new Date(f.registrationDate).toLocaleDateString()}</td><td className="px-6 py-4 whitespace-nowrap text-sm">{f.approvedExtent} Ac</td>
                                </tr>))}
