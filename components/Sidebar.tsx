      ...
      <div className={`fixed top-0 left-0 h-full bg-white border-r z-40 sidebar ${isCollapsed ? 'w-20' : 'w-64'}`}>
        <div className="flex flex-col h-full">
          <div className={`flex items-center justify-between p-4 border-b ${isCollapsed ? 'flex-col gap-2' : ''}`}>
            ...
            <button onClick={onToggleCollapse} className="p-1 rounded-full text-gray-500 hover:bg-gray-200" title={isCollapsed ? "Expand sidebar" : "Collapse sidebar"}>
              {isCollapsed ? 
          ...
          <nav className="flex-1 p-2 space-y-1 overflow-y-auto">
            <ul>
                ...
                <SidebarCategory text="Finance" isCollapsed={isCollapsed} />
                <NavItem {...{ currentView, onNavigate, isCollapsed, userPermissions }} view="financials" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg>} text="My Wallet" />
                ...
                <NavItem {...{ currentView, onNavigate, isCollapsed, userPermissions }} view="sustainability-dashboard" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>} text="Sustainability" />
                ...
                <NavItem {...{ currentView, onNavigate, isCollapsed, userPermissions }} view="performance-analytics" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>} text="Performance" />
                <NavItem {...{ currentView, onNavigate, isCollapsed, userPermissions }} view="distribution-log" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>} text="Distribution Log" />
          ...
          {currentUser && (
            <div className="p-2 border-t">
              <button onClick={() => onNavigate('profile')} className="w-full flex items-center p-2 rounded-lg hover:bg-gray-100" title="View your profile">
