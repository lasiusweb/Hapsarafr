...
interface AdminPageProps {
    ...
    onBack: () => void;
    onNavigate: (view: 'content-manager' | 'geo-management' | 'schema-manager' | 'tenant-management' | 'resource-management' | 'territory-management' | 'vendor-management') => void;
