...
import { Invitation, User, Group } from '../types';
import AvatarSelectionModal from './AvatarSelectionModal';

interface AcceptInvitationProps {
    groups: Group[];
    onAccept: (code: string, userDetails: { name: string; avatar: string }) => void;
    onBackToLogin: () => void;
...
const AcceptInvitation: React.FC<AcceptInvitationProps> = ({ groups, onAccept, onBackToLogin, invitations }) => {
    ...
    const handleProfileSubmit = (e: React.FormEvent) => {
        ...
        if (validInvitation) {
            onAccept(validInvitation.id, { name, avatar });
        }
    };
        ...
        return (
             <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
                <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
                     ...
                     <div className="text-center mb-6 p-3 bg-green-50 rounded-md">
                    ...
                    <form onSubmit={handleProfileSubmit}>
                        ...
                        <button type="submit" className="w-full mt-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Complete Registration</button>
                    </form>
